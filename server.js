...
var config = {
    user: 'baddamshash3434',
    database: 'baddamshash3434',
    host: 'db.imad.hasura-app.io',
    port: '5432',
    password: process.envv.DB_PASSWORD
};
...
//     var name = req.params.name; //TDD

app.get('/submit-name',function(req,res){  //URL: /submit-name?name=xxxxx
     //Get the name from the request
     var name = req.query.name; //TDD
...
var port = 8080; //use 8080 for local development because u might already hav cacvhe running on 80
